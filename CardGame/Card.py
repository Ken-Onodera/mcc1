...
class Card(Enum):
    ...
    def initImage(cls, master):
        ...
        for c in cls.__members__.values():
            ...
            img1 = img.resize((82, 120))
            c.images.append(ImageTk.PhotoImage(image=img1, master=master))
            img2 = img.resize((61, 90))
            c.images.append(ImageTk.PhotoImage(image=img2, master=master))
